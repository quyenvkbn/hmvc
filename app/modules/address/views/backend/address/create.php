						...
						<div class="tab-pane active" id="tab-info">
							<div class="box-body">
								<div class="form-group">
									...
									<div class="col-sm-4">
										<?php echo form_input('title', set_value('title'), 'class="form-control" placeholder="Tên phòng"');?>
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<?php echo form_input('attachs', set_value('attachs'), 'class="form-control" placeholder="Files đính kèm" onclick="openKCFinder(this, files)"');?>
									</div>
								</div>
							</div><!-- /.box-body -->
						</div><!-- /.tab-pane -->
