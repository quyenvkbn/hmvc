...
class Catalogues extends FC_Controller{
	...
	public function View($id = 0, $page = 1){
		...
		$data['list'] = $this->FrontendArticlesCatalogues_Model->ReadByCondition(array('select' => 'id, title, slug, canonical, images, lft, rgt','where' => array('trash' => 0,'publish' => 1, 'parentid' => $DetailCatalogues['id'], 'alanguage' => ''.$this->fc_lang.''),'limit' => 6,'order_by' => 'order asc, id desc'));
