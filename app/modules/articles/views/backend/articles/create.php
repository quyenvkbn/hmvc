					...
					<ul class="nav nav-tabs">
						...
						<div class="tab-content">
							<div class="tab-pane active" id="tab-seo">
								<div class="form-group">
									<label class="col-sm-12 control-label tp-text-left">Ảnh đại diện chính</label>
								</div>
								<div class="form-group">
									<div class="col-sm-12">
								...
								<div class="form-group">
										...
										<div class="col-sm-10">
											<?php echo form_input('content2', set_value('content2'), 'class="form-control" placeholder="Banner" onclick="openKCFinder(this)"');?>
										</div>
									</div>
								<div class="form-group">
