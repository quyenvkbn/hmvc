							...
							<div class="tab-pane active" id="tab-info">
								<div class="box-body">
									...
									<div class="form-group hide">
										<label class="col-sm-2 control-label tp-text-left">Ghi chú SV</label>
										<div class="col-sm-10">
											<?php echo form_textarea('content2', set_value('content2', $DetailArticles['content2']), 'class="form-control" placeholder="Ghi chú SV" style="width: 100%; height: 120px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"'); ?>
										</div>
									</div>
									<div class="form-group">
							...
							<div class="tab-pane active" id="tab-seo">
								...
								<div class="form-group">
									<div class="col-sm-12">
										...
										<?php echo form_input('images', set_value('images', $DetailArticles['images']), 'class="form-control"  placeholder="Ảnh đại diện chính" onclick="openKCFinder(this)" ');?>
									</div>
								</div>
								<div class="form-group">
										<label class="col-sm-2 control-label tp-text-left">Banner</label>
										<div class="col-sm-10">
											<?php echo form_input('content2', set_value('content2', $DetailArticles['content2']), 'class="form-control" placeholder="Banner" onclick="openKCFinder(this)" ');?>
										</div>
									</div>
								<div class="form-group">
