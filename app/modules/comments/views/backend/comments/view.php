		...
		<div class="box-body table-responsive no-padding">
			<table class="table table-hover table-bordered table-striped">
				<tr>
					...
					<th style="text-align:center; width: 130px;">Đánh giá</th>
				...
				<tr>
					...
					<td class="<?php echo (($comment['type'] == 1) ? 'red' : '') ?>"><?php echo $comment['fullname']; ?><br/><?php echo $comment['email'];?> </td></td>
					<td style="text-align:center;"><a target="_blank" href="<?php echo $href; ?>" title="<?php echo $title; ?>"><i class="fa fa-link"></i></a></td>
					<td style="text-align:center;"><?php for($i = 1; $i <= 5; $i++){ ?> <i class="fa fa-star" style="color: #fd4;"></i> <?php  } ?></td>
