...
<section class="sidebar">
	...
	<?php if(in_array('customers/backend/groups/view', $this->fcUser['group']) && in_array('customers', $dropdown)){ ?>
		<li class="treeview <?php echo ($this->router->module == 'customers')?'active':'';?>">
			<a href="<?php echo site_url('customers/backend/customers/view');?>"><i class="fa fa-user-plus"></i><span>Người dùng</span> <i class="fa fa-angle-left pull-right"></i></a>
			<ul class="treeview-menu">
			<?php if(in_array('customers/backend/groups/view', $this->fcUser['group'])){ ?>
				<li><a href="<?php echo site_url('customers/backend/groups/view');?>"><i class="fa fa-caret-right"></i>Nhóm người dùng</a></li>
			<?php } ?>
				<li><a href="<?php echo site_url('customers/backend/customers/view');?>"><i class="fa fa-caret-right"></i>Danh sách người dùng</a></li>
				<?php if(in_array('customers/backend/formlist/view', $this->fcUser['group'])){ ?>
					<li><a href="<?php echo site_url('customers/backend/formlist/view');?>"><i class="fa fa-caret-right"></i> Khách hàng - Biểu mẫu</a></li>
				<?php } ?>
			</ul>
		</li>
	<?php } ?>
	...
	<?php if(in_array('products/backend/products/view', $this->fcUser['group']) && in_array('products', $dropdown)){ ?>
		<li class="treeview <?php echo ($this->router->module == 'products')?'active':'';?>">
			...
			<?php } ?>
				...
				<li><a href="<?php echo site_url('combos/backend/combos/view');?>"><i class="fa fa-caret-right"></i>Combos<span class="pull-right-container">
				</span></a></li>
			<?php } ?>
			</ul>
		</li>
	...
	<?php if(in_array('contacts/backend/home/view', $this->fcUser['group']) && in_array('contacts', $dropdown)){ ?>
		<li class="treeview <?php echo ($this->router->module == 'contacts')?'active':'';?> <?php echo ($this->router->module == 'mailsubricre')?'active':'';?>">
			<a href="<?php echo site_url('contacts/backend/home/view');?>"><i class="fa fa-calendar" ></i><span>Liên hệ</span> <i class="fa fa-angle-left pull-right"></i></a>
			<ul class="treeview-menu">
			...
			<?php } ?>
				<li><a href="<?php echo site_url('contacts/backend/home/view');?>"><i class="fa fa-caret-right"></i>Danh sách liên hệ</a></li>
						<li><a href="<?php echo site_url('mailsubricre/backend/mailsubricre/view');?>"><i class="fa fa-caret-right"></i>Danh sách liên hệ 2</a></li>
			</ul>
		</li>
	<?php } ?>
	...
	<?php if(in_array('users/backend/users/view', $this->fcUser['group']) && in_array('users', $dropdown)){ ?>
		...
		<li class="treeview <?php echo ($this->router->module == 'systems')?'active':'';?> <?php echo ($this->router->module == 'slides')?'active':'';?> <?php echo ($this->router->module == 'navigations')?'active':'';?> <?php echo ($this->router->module == 'files')?'active':'';?> <?php echo ($this->router->module == 'functions')?'active':'';?>">
			...
			<?php } ?>
			<?php if($this->fcUser['id'] == 3 || $this->fcUser['id'] == 7){ ?>
		...
		<?php if(in_array('test/backend/test/view', $this->fcUser['group']) && in_array('test', $dropdown)){ ?>
			<li><a href="<?php echo site_url('test/backend/test/view');?>"><i class="fa fa-caret-right"></i>Test<span class="pull-right-container">
					</span></a></li>
		<?php } ?>
