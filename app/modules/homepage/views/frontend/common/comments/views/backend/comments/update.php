						...
						<div class="tab-pane active" id="tab-info">
							<div class="box-body">
								<div class="form-group">
									...
									<div class="col-sm-5">
										<?php echo form_input('email', set_value('email', $DetailComments['email']), 'class="form-control" placeholder="Email"');?>
									</div>
								</div>
								<?php  
								...
								?>
								<div class="form-group">
									<label class="col-sm-2 control-label">Links comments</label>
									<div class="col-sm-10">
