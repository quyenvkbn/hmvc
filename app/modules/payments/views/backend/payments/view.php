	  ...
	  <div class="box">
		...
		<div class="box-body table-responsive no-padding">
			...
			<table class="table table-hover" id="diagnosis-list">
				...
				?>
				<tr>
					<td><a href="<?php echo site_url('payments/backend/items/view/'.$item['id'].''); ?>" title="" style="font-weight:bold;color:#006dad;"><?php echo '#'.(10000+$item['id']);?></a></td>
					...
					<td class="text-right">
						<div class="btn-group">
							<a href="<?php echo site_url('payments/backend/payments/delete/'.$item['id']).'?redirect='.urlencode(current_url());?>" class="btn btn-default"><span class="fa fa-trash"></span></a>
							<a href="<?php echo site_url('payments/backend/payments/update/'.$item['id']).'?redirect='.urlencode(current_url());?>" class="btn btn-default"><i class="fa fa-edit"></i></a>
						</div>
					 </td>
				</tr>
				<?php } ?>
