...
class BackendProducts_Model extends FC_Model{
	...
	public function Create($user = '', $catalogues = NULL, $albums = '', $itinerary = '', $review='', $lang = 'vietnamese'){
	...
	public function UpdateByPost($field = '', $value = 0, $user = '',  $catalogues = NULL, $albums = '', $itinerary = '', $review = ''){
		$price = (int)str_replace('.','',$this->input->post('price'));
		$saleoff = (int)str_replace('.','',$this->input->post('saleoff'));
		$data = array(
			'title' => $this->input->post('title'),
