							...
							<div class="tab-pane active" id="tab-info">
								<div class="box-body">
									...
									<div class="form-group hide">
										...
										<div class="col-sm-10">
											<?php echo form_textarea('content2', htmlspecialchars_decode(set_value('content2')), 'id="txtContent2" class="ckeditor-description" placeholder="Thông số kỹ thuật" style="width: 100%; height: 350px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"');?>
										</div>
									</div>
									<div class="form-group hide">
