						...
						<div class="tab-pane active" id="tab-info">
							<div class="box-body">
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										<?php echo form_input('skype', set_value('skype', $DetailSupports['skype']), 'class="form-control" placeholder="Địa chỉ"');?>
									</div>
								...
								<div class="form-group ">
									<label class="col-sm-2 control-label hide">Facebook</label>
