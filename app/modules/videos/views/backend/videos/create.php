							...
							<div class="tab-pane active" id="tab-info">
								<div class="box-body">
									<div class="form-group">
										...
										<div class="col-sm-8">
											<?php echo form_input('title', set_value('title'), 'class="form-control form-static-link" placeholder="Video"');?>
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<?php echo form_input('videos_code', set_value('videos_code'), 'class="form-control form-static-link" placeholder="Liên kết video"');?>
										</div>
									</div>
									<div class="form-group">
					...
					<ul class="nav nav-tabs">
						...
						<div class="tab-content">
							<div class="tab-pane active" id="tab-seo">
								...
								<div class="form-group">
									<div class="col-sm-12">
										<?php echo form_input('video', set_value('video'), 'class="form-control"  placeholder="Video upload" onclick="openKCFinder(this, \'media\')" ');?>
									</div>
								</div>
								...
								<div class="form-group">
									<div class="col-sm-12">
										<?php echo form_dropdown('productid', $products, set_value('productid', 0), 'class="form-control" style="width: 100%;"');?>
									</div>
								</div>
								<?php } ?>
								<div class="form-group">
